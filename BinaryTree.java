public class BinaryTree {
    ...
    private boolean remove(int value) {
        if (root == null)
            ...
            if (son.getLeft() == null && son.getRight() == null) { // Primeiro caso -> remover folhas
                ...
                Node fatherRightLeft = farLeftPossible(son, son.getRight()); // encontrou o pai do mais a esquerda
                                                                             // possivel
    ...
    private int privNotTerminalNodes(Node current) {
        ...
        if (current.getLeft() != null || current.getRight() != null) {
            count++;
            privNotTerminalNodes(current.getLeft());
            privNotTerminalNodes(current.getRight()); 
        }
        return count;
    }
